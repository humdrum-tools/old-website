...
~~~~~~~~~
    ...
    It is recommended that files containing predominantly ``**vox#``
    data should be given names with the distinguishing \`.vox'
    extension.
...
~~~~~~~~~~~~~~~~~~
    ...
    The following Humdrum command produces **\*\*vox#** data as output:
        ...
        +----+--------------------------------------+------------------------------------------------------------------------------------------------+
        |    | `**vox** <../commands/vox.html>`__   | determine number of concurrently active voices for **\*\*cbr**, **\*\*cents**,                 |
        +----+--------------------------------------+------------------------------------------------------------------------------------------------+
