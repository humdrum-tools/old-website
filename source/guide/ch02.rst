...
The :exinterp:`kern` representation can be used to represent basic or core
...
`Chapter 6 <../ch06>`_.  Our intention here is to provide a quick introduction.
...
.. literalinclude:: examples/ex2-2.krn 
	:language: kern
...
.. literalinclude:: examples/ex2-3.krn 
	:language: kern
...
.. literalinclude:: examples/ex2-4.krn 
	:language: kern
