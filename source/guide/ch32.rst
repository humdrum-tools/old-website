...
Suppose that we have two `**semits <../../rep/semits>`_ spines as input and we would like to
...
example, suppose we had four spines of `**solfa <../../rep/solfa>`_ data and we want to
...
input tokens or fields and stores the value in the varible `NF <../../man/NF>`_. Simply
replacing the number ``4`` by `NF <../../man/NF>`_ will achieve our goal. In our revised
