...
Data in the ``**pitch``_ or \*\*kern_ representations can be translated
...
are illustrated in Example 4.1. (The corresponding \*\*kern_
...
melody to ``**semits``_ and then back to \*\*kern_ will standarize all
