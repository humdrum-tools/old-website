...
.. csv-table::
        ...
        T,      match any |**kern|_ note containing a whole-tone trill
        [Tt],   match any |**kern|_ note containing a whole-tone or half-tone trill
        -,      match any |**kern|_ note containing at least one flat
        [#],    match any |**kern|_ note containing a sharp (including a double-sharp etc.)
        [#n-;], match any |**kern|_ note containing an accidental (including a natural)
        [A-Ga-g]+,      match any diatonic pitch letter-name    
        [0-9]+/.,        match |**kern|_ dotted durations
        [0-9]+/./.[^.], match only doubly-dotted durations
        [Gg]+[^#-],     match any |**kern|_ pitch `G' that does not have a sharp or flat
