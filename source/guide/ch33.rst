...
`**IPA <../../rep/IPA>`_ <representations/IPA.rep.html>`__ scheme for representing
speech sounds. This representation provides a companion to the
`**text <../../rep/text>`_ <representations/text.rep.html>`__ and
`**silbe <../../rep/silbe>`_ <representations/silbe.rep.html>`__ representations
...
The Humdrum `**IPA <../../rep/IPA>`_ <representations/IPA.rep.html>`__ scheme provides
a way to represent the International Phonetic Alphabet. The `**IPA <../../rep/IPA>`_
...
`**IPA <../../rep/IPA>`_ mappings for various phonemes.
...
`**text <../../rep/text>`_ <representations/text.rep.html>`__ or
`**silbe <../../rep/silbe>`_ <representations/silbe.rep.html>`__ representations to
`**IPA <../../rep/IPA>`_ <representations/IPA.rep.html>`__. However, there are a
...
Given an `**IPA <../../rep/IPA>`_ input, occurrences of alliteration can be found by
first isolating the initial phoneme for each word using **humsed**. This
task requires some additional knowledge about using
`**humsed** <commands/humsed.html>`__. Both `sed <http://en.wikipedia.org/wiki/Sed>`_ and **humsed**
...
First we extract the `**IPA <../../rep/IPA>`_ <representations/IPA.rep.html>`__ spine
...
provided by `sed <http://en.wikipedia.org/wiki/Sed>`_ and **humsed**. Recall that operations such as
...
values together. The basic pipeline will extract the pertinent `**IPA <../../rep/IPA>`_
...
The corresponding output would indicate the rhyme scheme for this poem:
    ...
    script and applied to any input containing `**IPA <../../rep/IPA>`_ text. The
    ...
    By focusing on phonetic signifiers, the `**IPA <../../rep/IPA>`_ representation
    ...
    `**IPA <../../rep/IPA>`_ <representations/IPA.rep.html>`__ representation can be
    used in conjunction witht the
    `**silbe <../../rep/silbe>`_ <representations/silbe.rep.html>`__ representation to
