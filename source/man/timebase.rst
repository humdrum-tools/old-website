...
The time-base is selected by assigning a ``**recip`` duration value to
the **-t** option. Time-base durations may be dotted.
...
will remove ``**kern`` or ``**recip`` duration encodings from the
output; each output data record will represent an elapsed duration of a
dotted eighth note.
...
-  `**Pertinent description in the Humdrum User
   Guide** <../guide13.html#Aligning_Durations_Using_the_timebase_Command>`__
