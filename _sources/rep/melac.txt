...
~~~~~~~~~~~
    ...
    The **\*\*melac** representation is used to characterize the degree
    of pitch-related stress (melodic accent) for successive moments.
    Three types of tokens are recognized by **\*\*melac**:
    stress-tokens, rests, and barlines. Stress-tokens encode decimal
    values ranging between 0 (no stress) and 1 (maximum stress).
...
~~~~~~~~~
    ...
    It is recommended that files containing predominantly ``**melac``
    data should be given names with the distinguishing \`.mac'
    extension.
...
~~~~~~~~
    ...
    No. 1. The corresponding `**\*\*kern** <kern.rep.html>`__ and
    `**\*\*semits** <semits.rep.html>`__ representations are also shown:
...
~~~~~~~~~~~~~~~~~~
    ...
    The following Humdrum command produces **\*\*melac** data as output:
        ...
        +----+------------------------------------------+----------------------------------------------------------+
        |    | `**melac** <../commands/melac.html>`__   | calculate melodic accent values for successive pitches   |
        +----+------------------------------------------+----------------------------------------------------------+
