...
**melac** -- calculate melodic accent values for successive pitches in a
Humdrum input
...
Joseph Thomassen (see `REFERENCES <#REFERENCES>`__). Thomassen's model
is sensitive to pitch contour only -- distinguishing just three types of
...
`Huron, D. & Royal, M. </Humdrum/Huron/publications.html>`__ "What is
