...
scope="col" align="center" \| Option type ! scope="col" align="left" \|
Description ! scope="col" align="left" \| Options value access \|- \| b
\|\| boolean (true or false) \|\| .getBoolean("OptionName") \|- \| i
\|\| integer \|\| .getInteger("OptionName") \|- \| d \|\| double
(floating-point number) \|\| .getDouble("OptionName") \|- \| s \|\|
string \|\| .getString("OptionName") \|}
...
! scope="col" align="center" \| Option definition ! scope="col"
align="left" \| Command-line examples \|- valign="baseline" \| "r=b"
\|\| command -r \|- valign="baseline" \| "m=i" \|\| command -m 10 or
command -m10 \|- valign="baseline" \| "v\|value=d" \|\| command -v 5.23
or command -v5.23
| command --value 5.23
| command --value=5.23 \|- valign="baseline" \| "t=s" \|\| command -t
string or command -tstring
...
The
`PerlRegularExpression <http://extras.humdrum.org/download/humextra/include/PerlRegularExpression.h>`__
...
.. figure:: RandomMelody.png
   :alt: RandomMelody.png
