...
```**kern``-encoded <../representations/kern.html>`__ files. It may be
used to assist in the detection and correction of ``**kern`` encoding
errors.
...
-  `**Pertinent description in the Humdrum User
   Guide** <../guide13.html#Checking_an_Assembled_Score_Using_proof>`__
