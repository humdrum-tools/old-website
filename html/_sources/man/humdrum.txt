...
with the restriction that no *data records* or *local comments* appear
without a prior *exclusive interpretation,* and that the file maintain a
coherent *spine* organization.
...
``humdrum_.exe`` (``humdrum_`` on UNIX) rather than ``humdrum.exe``.
...
`**census** <census.html>`__ (4), `**proof** <proof.html>`__ (4)
...
-  `**Pertinent description in the Humdrum User
   Guide** <../guide05.html#The_humdrum_Command>`__
