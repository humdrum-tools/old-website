...
confusion. The **-x** option is useful for eliminating non-pitch-related
signifiers from the output. For most ``**kern`` inputs, the **-x**
...
``**cocho``) cannot be processed by **semits.** In addition, there are
